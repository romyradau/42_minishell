...
FILES = 0_minishell.c 1_process_package.c 2_fill_package.c 3_package_calculator.c special_split.c print_stuff.c \
		./utils/sig_handls.c ./utils/builtins.c ./utils/ft_echo.c ./utils/ft_exe_cd.c  ./utils/ft_env_func.c \
